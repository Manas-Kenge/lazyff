...
All notable changes to lazyff are documented here.

## [0.0.1] - Initial Release

The first release of lazyff, providing a simple wrapper around ffmpeg with an interactive TUI.
...
lazyff follows [Semantic Versioning](https://semver.org/):
...
- [GitHub Releases](https://github.com/Manas-Kenge/lazyff/releases)
- [GitHub Issues](https://github.com/Manas-Kenge/lazyff/issues)
